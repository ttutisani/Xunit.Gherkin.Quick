...
Build Status: [![Build](https://github.com/ttutisani/Xunit.Gherkin.Quick/actions/workflows/build.yml/badge.svg)](https://github.com/ttutisani/Xunit.Gherkin.Quick/actions/workflows/build.yml)
